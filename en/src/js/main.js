...
window.addEventListener("load", (event) => {
  ...
  function showPopup() {
    ...
    document.getElementById("noBtn").addEventListener("click", () => {
      localStorage.setItem("langPopupShownEn", "true");
      popup.remove();
    });
  ...
  const popupShown = localStorage.getItem("langPopupShownEn");
  ...
  const productsParagraph = createEl("p", { class: "productsButton" }, "Products");
  ...
  document.querySelector(".languageSelector > div:nth-child(1)").addEventListener("click", function () {
    ...
    let newUrl = currentUrl.slice(0, domainEndIndex) + newPath;
  ...
  contactInfo1.innerHTML = "<p>Phone number</p><p>+98-21-44403448<br />+98-21-44000408</p>";
  contactDiv.appendChild(contactInfo1);

  const contactInfo2 = document.createElement("div");
  contactInfo2.innerHTML = "<p>Mobile number</p><p>+98-912-2991782<br />+98-912-2087393</p>";
